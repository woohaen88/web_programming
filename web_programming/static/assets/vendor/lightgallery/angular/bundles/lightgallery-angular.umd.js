(function (global, factory) {
    ...
    LightgalleryService.ɵprov = /*@__PURE__*/ i0__namespace.ɵɵdefineInjectable({
    ...
    LightgalleryComponent.ɵfac = function LightgalleryComponent_Factory(t) {
        return new (t || LightgalleryComponent)(i0__namespace.ɵɵdirectiveInject(i0__namespace.ElementRef));
    };
    LightgalleryComponent.ɵcmp = /*@__PURE__*/ i0__namespace.ɵɵdefineComponent({
    ...
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0__namespace.ɵsetClassMetadata(LightgalleryComponent, [{
            ...
            return [{type: i0__namespace.ElementRef}];
        }, {
            settings: [{
                type: i0.Input
            }], onAfterAppendSlide: [{
    ...
    (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && i0__namespace.ɵɵsetNgModuleScope(LightgalleryModule, {
            declarations: [LightgalleryComponent],
            exports: [LightgalleryComponent]
        });
    })();
