...
urlpatterns = [
    ...
    path("camping_item/", views.CampingItemListView.as_view(), name = "camping_item_index"),
    path("camping_item/create", views.CampingItemCreateView.as_view(), name = "camping_item_create"),
